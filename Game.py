...
class Displacement:
    ...
    def __call__(self, direction: str) -> Any:
...
class Encounter:
    def __init__(self, stats: Any, weapons: Any, armour: Any, levels: Any, enemy: Any) -> None:
...
def encounter_xy_sigmoid(distance_x, distance_y):
    total_chance = 0
...
def start_game(stats, weapons, armour, levels) -> None:
