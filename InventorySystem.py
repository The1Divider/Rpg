...
class Inventory:
    ...
    def get_item(self, item: str) -> Any:
    ...
    def stats_setup(self) -> list:
        ...
        hp, dmg, defence, crit, block = self.Stats.hp, self.Stats.dmg, self.Stats.defence, self.Stats.crit, self.Stats.block
